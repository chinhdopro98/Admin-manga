...
const CreateItemDialog: React.FC<ConfirmCreateDialogProps> = ({ open, onClose, onConfirm, inputValue, onInputChange, name = '' }) => {
...
export default React.memo(CreateItemDialog, areEqual);
